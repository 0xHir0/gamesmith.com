      ...
      2: [
        function (require, module, exports) {
          (function (global) {
            ...
            var _utilsStripDiacritics2 = _interopRequireDefault(
              _utilsStripDiacritics
            );
            ...
            function getFromCache(cache, input) {
              ...
              for (var i = input.length; i >= 0; --i) {
                ...
                if (
                  cache[cacheKey] &&
                  (input === cacheKey || cache[cacheKey].complete)
                ) {
            ...
            var stringOrNode = PropTypes.oneOfType([
              PropTypes.string,
              PropTypes.node,
            ]);

            var Async = createReactClass({
              displayName: "Async",
        ...
        { "./Select": 4, "./utils/stripDiacritics": 6 },
      ],
      3: [
        function (require, module, exports) {
          (function (global) {
      ...
      4: [
        function (require, module, exports) {
          (function (global) {
            ...
            var _reactInputAutosize =
              typeof window !== "undefined"
                ? window["AutosizeInput"]
                : typeof global !== "undefined"
                ? global["AutosizeInput"]
                : null;

            var _reactInputAutosize2 =
              _interopRequireDefault(_reactInputAutosize);
            ...
            var Select = createReactClass({
              ...
              componentDidUpdate: function componentDidUpdate(
                ...
                if (
                  ...
                  var focusedOptionNode = _reactDom2["default"].findDOMNode(
                    this.refs.focused
                  );
                ...
                if (
                  ...
                  var focusedDOM = _reactDom2["default"].findDOMNode(
                    this.refs.focused
                  );
                ...
                if (this.props.scrollMenuIntoView && this.refs.menuContainer) {
                  var menuContainerRect =
                    this.refs.menuContainer.getBoundingClientRect();
                  if (
                    window.innerHeight <
              ...
              handleTouchEndClearValue: function handleTouchEndClearValue(
                event
              ) {
                // Check if the view is being dragged, In this case
                // we don't want to fire the click event (because the user only wants to scroll)
              ...
              handleInputBlur: function handleInputBlur(event) {
                ...
                if (
                  this.refs.menu &&
                  (this.refs.menu === document.activeElement ||
              ...
              getValueArray: function getValueArray(value, nextProps) {
                ...
                var props =
                  typeof nextProps === "object" ? nextProps : this.props;
                if (props.multi) {
              ...
              renderValue: function renderValue(valueArray, isOpen) {
                ...
                var renderLabel =
                  this.props.valueRenderer || this.getOptionLabel;
                ...
                var onClick = this.props.onValueClick
              ...
              renderInput: function renderInput(
                ...
                if (this.props.inputRenderer) {
                  ...
                  if (this.props.disabled || !this.props.searchable) {
                    var divProps = (0, _blacklist2["default"])(
                  ...
                  if (this.props.autosize) {
                    return _react2["default"].createElement(
                      ...
                      _extends({}, inputProps, { minWidth: "5px" })
                    );
                  }
                  return _react2["default"].createElement(
                    "div",
              ...
              filterOptions: function filterOptions(excludeOptions) {
                ...
                if (typeof this.props.filterOptions === "function") {
                  return this.props.filterOptions.call(
                    this,
                    options,
                    filterValue,
                    excludeOptions
                  ...
                  if (this.props.ignoreAccents) {
                    filterValue = (0, _utilsStripDiacritics2["default"])(
                      filterValue
                    );
                  }
                  ...
                  return options.filter(function (option) {
                    if (
                      excludeOptions &&
                      excludeOptions.indexOf(option[_this5.props.valueKey]) > -1
                    )
                      return false;
                    if (_this5.props.filterOption)
                      return _this5.props.filterOption.call(
                        _this5,
                        option,
                        filterValue
                      );
                    ...
                    if (_this5.props.ignoreAccents) {
                      if (_this5.props.matchProp !== "label")
                        valueTest = (0, _utilsStripDiacritics2["default"])(
                          valueTest
                        );
                      if (_this5.props.matchProp !== "value")
                        labelTest = (0, _utilsStripDiacritics2["default"])(
                          labelTest
                        );
                    }
                    ...
                    return _this5.props.matchPos === "start"
                      ? (_this5.props.matchProp !== "label" &&
                          valueTest.substr(0, filterValue.length) ===
                            filterValue) ||
                          (_this5.props.matchProp !== "value" &&
                            labelTest.substr(0, filterValue.length) ===
                              filterValue)
                      : (_this5.props.matchProp !== "label" &&
                ...
                if (options && options.length) {
                  if (this.props.menuRenderer) {
                    ...
                    var _ret = (function () {
                      ...
                      var renderLabel =
                        _this6.props.optionRenderer || _this6.getOptionLabel;

                      return {
                        v: options.map(function (option, i) {
                          var isSelected =
                            valueArray && valueArray.indexOf(option) > -1;
                          var isFocused = option === focusedOption;
                          var optionRef = isFocused ? "focused" : null;
                          var optionClass = (0, _classnames2["default"])(
                            _this6.props.optionClassName,
                            {
                              "Select-option": true,
              ...
              getFocusableOptionIndex: function getFocusableOptionIndex(
                selectedOption
              ) {
                var options = this._visibleOptions;
              ...
              renderOuter: function renderOuter(
                options,
                valueArray,
                focusedOption
              ) {
              ...
              render: function render() {
                ...
                if (focusedOptionIndex !== null) {
                  focusedOption = this._focusedOption =
                    this._visibleOptions[focusedOptionIndex];
                } else {
