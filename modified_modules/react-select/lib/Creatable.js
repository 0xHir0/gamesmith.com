...
var _utilsDefaultFilterOptions2 = _interopRequireDefault(
  _utilsDefaultFilterOptions
);

var _utilsDefaultMenuRenderer = require("./utils/defaultMenuRenderer");

var _utilsDefaultMenuRenderer2 = _interopRequireDefault(
  _utilsDefaultMenuRenderer
);
...
var Creatable = createReactClass({
  ...
  createNewOption: function createNewOption() {
    ...
    var shouldKeyDownEventCreateNewOption =
  ...
  onInputKeyDown: function onInputKeyDown(event) {
    var shouldKeyDownEventCreateNewOption =
      this.props.shouldKeyDownEventCreateNewOption;
  ...
  render: function render() {
    ...
    var children =
      _props3$children === undefined ? defaultChildren : _props3$children;
    var newOptionCreator = _props3.newOptionCreator;
    var shouldKeyDownEventCreateNewOption =
      _props3.shouldKeyDownEventCreateNewOption;

    var restProps = _objectWithoutProperties(_props3, [
      "children",
      "newOptionCreator",
