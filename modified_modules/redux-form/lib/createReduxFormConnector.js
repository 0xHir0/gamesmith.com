...
var _createHigherOrderComponent2 = _interopRequireDefault(
 ...
 */
var createReduxFormConnector = function createReduxFormConnector(
  isReactNative,
  React,
  connect
) {
  return function (
    ...
    var ReduxFormConnector = (function (_Component) {
      ...
      function ReduxFormConnector(props) {
        ...
        _this.cache = new _noGetters2.default(_this, {
          ReduxForm: {
            ...
            fn: (0, _createHigherOrderComponent2.default)(
              props,
              isReactNative,
              React,
              connect,
      ...
      ReduxFormConnector.prototype.componentWillReceiveProps =
      ...
      ReduxFormConnector.prototype.render = function render() {
        ...
        var passableProps = _objectWithoutProperties(_props, [
          "reduxMountPoint",
          "destroyOnUnmount",
          "form",
          "getFormState",
    ...
    ReduxFormConnector.displayName =
      "ReduxFormConnector(" +
      (0, _getDisplayName2.default)(WrappedComponent) +
      ")";
