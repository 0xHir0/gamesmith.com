 ...
 */
var createHigherOrderComponent = function createHigherOrderComponent(
  config,
  isReactNative,
  React,
  connect,
  ...
  return function (reduxMountPoint, formName, formKey, getFormState) {
    var ReduxForm = (function (_Component) {
      ...
      function ReduxForm(props) {
        ...
        _this.fields = (0, _readFields2.default)(
          props,
          {},
          {},
          _this.asyncValidate,
      ...
      ReduxForm.prototype.componentWillReceiveProps =
        function componentWillReceiveProps(nextProps) {
          if (
            !(0, _deepEqual2.default)(this.props.fields, nextProps.fields) ||
            !(0, _deepEqual2.default)(this.props.form, nextProps.form, {
              strict: true,
            })
          ) {
            this.fields = (0, _readFields2.default)(
              nextProps,
              this.props,
              this.fields,
              this.asyncValidate,
      ...
      ReduxForm.prototype.componentWillUnmount =
        ...
        if (asyncValidate) {
          var _ret = (function () {
            ...
            var syncValidationPasses =
              isSubmitting || (0, _isValid2.default)(syncErrors[name]);
            if (
              alwaysAsyncValidate ||
      ...
      ReduxForm.prototype.handleSubmit = function handleSubmit(submitOrEvent) {
        ...
        return !submitOrEvent || (0, _silenceEvent2.default)(submitOrEvent)
          ? // submitOrEvent is an event: fire submit
            (0, _handleSubmit3.default)(
              check(onSubmit),
              (0, _getValues2.default)(fields, form),
              this.props,
              this.asyncValidate
            )
          : // submitOrEvent is the submit function: return deferred submit thunk
            (0, _silenceEvents2.default)(function () {
              return (0,
              _handleSubmit3.default)(check(submitOrEvent), (0, _getValues2.default)(fields, form), _this3.props, _this3.asyncValidate);
            });
      };
      ...
      ReduxForm.prototype.render = function render() {
        ...
        var passableProps = _objectWithoutProperties(_props4, [
          "addArrayValue",
          "asyncBlurFields",
          "autofill",
          "blur",
        ...
        var passedProps = propNamespace
          ? ((_ref = {}), (_ref[propNamespace] = props), _ref)
          : props;
        return React.createElement(
          WrappedComponent,
          _extends({}, passableProps, passedProps)
        );
      };
    ...
    ReduxForm.displayName =
      "ReduxForm(" + (0, _getDisplayName2.default)(WrappedComponent) + ")";
    ...
    var decorate =
      formKey !== undefined && formKey !== null
        ? connect(
            (0, _wrapMapStateToProps2.default)(
              mapStateToProps,
              function (state) {
                var formState = getFormState(state, reduxMountPoint);
                if (!formState) {
                  throw new Error(
                    'You need to mount the redux-form reducer at "' +
                      reduxMountPoint +
                      '"'
                  );
                }
                return (
                  formState &&
                  formState[formName] &&
                  formState[formName][formKey]
                );
              }
            ),
            (0, _wrapMapDispatchToProps2.default)(
              mapDispatchToProps,
              (0, _bindActionData2.default)(unboundActions, {
                form: formName,
                key: formKey,
              })
            ),
        ...
        : connect(
            ...
            (0, _wrapMapDispatchToProps2.default)(
              mapDispatchToProps,
              (0, _bindActionData2.default)(unboundActions, { form: formName })
            ),
            mergeProps,
            options
          );
